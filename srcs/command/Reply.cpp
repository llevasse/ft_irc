...
std::string RPL_UMODEIS(std::string arg1, std::string arg2) { return ("221 " + arg1 + arg2);}
...
std::string ERR_NOSUCHNICK( std::string arg1, std::string arg2 ) { return ("401 " + arg1 + arg2 + ":No such nickname");}
